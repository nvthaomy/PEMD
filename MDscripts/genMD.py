...
buildFile, pdbOut, f = singleChain.BuildPoly(f,N,Pm,pattern, monName, neutralMons, ionizedMons, headName,tailName,libs)
...
if __name__ == "__main__":
    '''Need to be executed in a folder with 
       ...
       f, N, Pm, np, ff are lists with length = # polymer species (PAA, PAH)
       -l includes all monomer libraries
       -e or -r flags will be applied for all polymer species'''
    ...
    parser.add_argument("-l",nargs ="+",
                        help="tleap libraries for PAA monomers: PAA.lib, PAA_avg.lib,PAA1.lib")
